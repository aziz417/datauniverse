    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a class="" data-toggle="dropdown" href="#" aria-expanded="false">
                <img style="width: 35px; height: auto" class="img-circle elevation-2" src="{{ auth()->user()->image->url ?? asset('backend/dist/img/user8-128x128.jpg') }}">
                </a>
            <div class="dropdown-menu" style="">
                <a class="dropdown-item" tabindex="-1" href="{{ route('admin.profile') }}">{{ ucfirst(auth()->user()->name) }}</a>
                <a class="dropdown-item" tabindex="-1" href="{{ route('admin.profile') }}">Profile</a>
                <a class="dropdown-item" tabindex="-1" href="{{ route('admin.profile') }}">Change Password</a>
                <a class="dropdown-item" tabindex="-1" href="#">Activities</a>
