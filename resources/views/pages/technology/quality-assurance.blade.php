...
@section('content')
    ...
    <div class="demo-2">
        <div id="container" class="intro-effect-fadeout">
            <!-- Top Navigation -->
            <header class="header">
                <div  class="bg-img"><img loading="lazy" src="http://images.tmcnet.com/tmc/misc/articles/image/2018-sep/7470843684-bigstock-quality-assurance-SUPERSIZE.jpg" alt="stock-quality-assurance Image"/></div>
            </header>
